...
-----
Last Modified: Sunday December 21st 2025 11:57:01 am
...
async def get_structured_data_by_id(id: str, brain_id: str = "default"):
    """
...
async def get_structured_data_list(
    ...
    def _get_list():
        return data_adapter.get_structured_data_list(
            brain_id, limit, skip, types, query_text
        )

    results, total = await asyncio.to_thread(_get_list)
